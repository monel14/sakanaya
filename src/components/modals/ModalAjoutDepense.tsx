...
interface ModalProps {
    closeModal: () => void;
    storeId?: number; // Optional storeId for pre-filling
}

const ModalAjoutDepense = ({ closeModal, storeId: preselectedStoreId }: ModalProps) => {
    const { addExpense, stores, showToast } = useAppContext();
    ...
    return (
        <>
            ...
            <div className="flex gap-2 justify-end mt-6">
                ...
                <button className="btn btn-primary" onClick={handleSave}>Enregistrer la dépense</button>
            </div>
        </>
    );
};

export default ModalAjoutDepense;