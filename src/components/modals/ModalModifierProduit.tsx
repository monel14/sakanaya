...
const ModalModifierProduit = ({ closeModal, product }: ModalProps) => {
    ...
    const handleSave = () => {
        ...
        updateProduct({ id: product.id, name, stockUnit, priceType, basePrice, productType });
        closeModal();
    };
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label className="text-sm muted">Prix de base (CFA)</label>
