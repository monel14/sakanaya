...
type LigneReceptionData = z.infer<typeof LigneReceptionSchema>;
...
export const BonReceptionForm: React.FC<BonReceptionFormProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="bg-blue-600 text-white px-6 py-4 rounded-t-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Nouveau Bon de Réception Fournisseur</h1>
              <p className="text-blue-100 text-sm">Enregistrement d'arrivage de marchandises</p>
            </div>
          </div>
          {onCancel && (
            <button
      ...
      <form onSubmit={form.handleSubmit((data) => onSubmit(data, false))} className="p-6 space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">📦 Lignes de Produits</h2>
            <button
              type="button"
              onClick={addLigne}
